...
def compare_faces_facenet(targetId, username):
    log.info("Trying to compare faces for student attendance with FaceNet for username ---->>"+ username)
    ...
    if facenetApiData is None:
        ...
        log.info(" Facial recognition with FaceNet username and confidence rating is" + facenetApiData.get('username')
