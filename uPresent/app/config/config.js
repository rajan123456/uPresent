...
export const baseUrlSchoolApi =
  'https://dev.upresent.ga/management/manage/school';
...
//PROD-MICRO
// export const baseUrlUserApi = 'https://user.upresent.ga/user';
...
//PROD-HEX
export const baseUrlUserHexApi = 'https://user-hex.upresent.ga/user';
export const baseUrlFileHexApi = 'https://user-hex.upresent.ga/file';
