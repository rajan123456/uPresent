...
public class AspectLogging {
	...
	@Around("execution( * com.upresent.metrics.controller..*.*(..)) || "
			+ "execution( * com.upresent.metrics..*.*(..)) || publicNonVoidRepositoryMethod()")
	public Object around(ProceedingJoinPoint joinPoint) throws MetricsException {
