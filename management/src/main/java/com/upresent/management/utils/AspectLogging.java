...
public class AspectLogging {
	...
	@Around("execution( * com.upresent.management.controller..*.*(..)) || "
			+ "execution( * com.upresent.management..*.*(..)) || publicNonVoidRepositoryMethod()")
	public Object around(ProceedingJoinPoint joinPoint) throws ManagementException {
